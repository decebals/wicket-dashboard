...
public class AddWidgetPanel extends Panel {
	...
	public AddWidgetPanel(String id, Dashboard dashboard) {
		super(id);
		
		this.dashboard = dashboard;
		
    	add(new BookmarkablePageLink<Void>("backDashboard", HomePage.class));
    	
		List<WidgetDescriptor> widgetDescriptors = DashboardApplication.get().getWidgetRegistry().getWidgetDescriptors();
	...
	private class WidgetDescriptorPanel extends Panel {
